...
class Config:
    ...
    def __init__(self, tag, using_hpc, train_folder, validation_folder, generated_sofa_folder_name=None, dataset=None, existing_model_tag=None, data_dir=None):
...
#********************* End of Added Code to Distinguish Between the Many Created Sofa Files************************************************************************    
        ...
        if using_hpc:
            # HPC data dirs
            self.data_dirs_path = '/rds/general/user/vd123/home/HRTF-upsampling-with-a-generative-' \
            ...
            self.amt_dir = '/rds/general/user/vd123/AMT/amt_code'
        else:
            # local data dirs
            self.data_dirs_path = '/home/vd123/HRTF-GANs-27Sep22-prep-for-publication'
            self.raw_hrtf_dir = Path('/home/vd123/HRTF_datasets')
            self.amt_dir = '/home/vd123/AMT/amt_code'
