...
from evaluation.evaluation import run_lsd_evaluation, lsd_personalization_evaluation, run_localisation_evaluation
...
def main(config, mode, noise, clean_hrtf_ratio):
...
#*********************Added Code to Train With Noisy Files************************************************************************      
        if noise == "with_noise":
            train_prefetcher, _ = load_dataset(config, noise_included=True, clean_hrtf_ratio=clean_hrtf_ratio, mean=None, std=None)
...
#*********************Added Code to Test With Noisy Files************************************************************************ 
        if noise == "with_noise":
...
#*********************Added Code to Compare the LSD of Subjects with the LSD of All Other Subjects And Average the Results************************************************************************ 
        #lsd_personalization_evaluation(config, config.valid_path)
#*********************End of Added Code to Compare the LSD of Subjects with the LSD of All Other Subjects And Average the Results************************************************************************ 
...
#*********************Added Code to Directly Create Sofa Files When HRTFs are Already in a Pickle Format************************************************************************ 
        ...
        convert_to_sofa(config.valid_noisy_hrtf_merge_dir, config, cube, sphere)
#*********************End of Added Code to Directly Create Sofa Files When HRTFs are already in a pickle format************************************************************************ 

#*********************Added Code to Check LSD of Noisy Files************************************************************************    
    elif mode == 'check_lsd_for_noisy_files':
        run_lsd_evaluation(config, config.valid_noisy_hrtf_merge_dir)
#*********************End of Added Code to Check LSD of Noisy Files************************************************************************    

if __name__ == '__main__':
    parser = argparse.ArgumentParser()

#*********************Added Code for Additional Arguments************************************************************************    
    ...
    parser.add_argument("--generated_sofa_file_folder_name")
    parser.add_argument("-r", "--clean_hrtf_ratio", type=float, default=1, 
                        help="Ratio of clean HRTF files to use in training (default: 1)")
    args = parser.parse_args()
#*********************End of Added Code for Additional Arguments************************************************************************    
    if args.hpc == "True":
        hpc = True
    elif args.hpc == "False":
        hpc = False
    ...
    if args.tag:
        ...
        tag = None
#*********************Added Code for Additional Arguments************************************************************************    
    config = Config(tag, using_hpc=hpc, train_folder=args.train_folder, validation_folder=args.validation_folder, synthetic_sofa_folder_name=args.generated_sofa_file_folder_name)
    main(config, args.mode, args.noise, args.clean_hrtf_ratio)
#*********************End of Added Code for Additional Arguments************************************************************************    
